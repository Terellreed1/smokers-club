...
const ProductsPreview = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-16 max-w-7xl mx-auto">
      {/* Header */}
      <ScrollReveal>
        ...
        {products.map((product, i) => (
          ...
          >
            <Link to={`/shop/${product.id}`} className="block">
              {/* Image container */}
              <div className="aspect-square bg-muted/30 border border-border/20 overflow-hidden relative mb-4">
                <motion.img
                  src={product.image}
                  alt={product.name}
